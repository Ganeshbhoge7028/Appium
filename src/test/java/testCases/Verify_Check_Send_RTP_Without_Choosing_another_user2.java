...
public class Verify_Check_Send_RTP_Without_Choosing_another_user2 {
	public static void main(String[] args)
			throws InterruptedException, MalformedURLException, IllegalMonitorStateException, IOException {
	...
	public static void sendRTPWithInvalidData(AndroidDriver driver) throws InterruptedException {
		...
		try {
			...
			String screenshotPath = "./Data/Screenshote/" + "sendRTPWithoutchoosingUcer122" + ".png";
